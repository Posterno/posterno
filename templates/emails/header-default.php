 ...
 *
 * This template can be overridden by copying it to yourtheme/posterno/emails/header-default.php
 *
...
$header_content_h1 = "
	...
	line-height: 1.2;
";
$header_img = pno_get_option( 'email_logo', '' );
$heading    = posterno()->emails->get_heading();
?>
<!DOCTYPE html>
<html>
	<head>
