...
- **[Reviews](https://posterno.com/extensions/reviews/)**: Supercharge your listings with reviews! Reviews are an extremely powerful tool for online conversions as they provide social proof. Whether you are listing restaurants, hotels, products, books, movies, games, or anything else, the reviews extension can accommodate any kind of listing type.
...
= 1.2.13 4th December 2020 =

- Fix: taxonomy layout template compatibility with some themes.

= 1.2.12 12th November 2020 =

- Fix: php namespace compatibility issue with WooCommerce & Posterno's geocoder.
...
- Tweak: updated CarbonFields library and fixed an issue where in some occasions you couldn't create admin notifications.
- Fix: unable to save the "hide from admin panel" option when creating listing fields.
...
- Added: nofolllow attribute to external links when added into the description of a listing.
- Added: ugc attribute to external links when added into the description of a listing.
- Added: ability to customize url slugs for listings and listings taxonomies.
- Added: pricing field automatic formatter into submission forms.
- Tweak: removed some obsolete code.
- Tweak: restricted access message "register" link now detects if an automatic redirect is required.
- Tweak: modified the text of the widget restricted usage message.
- Tweak: added "ugc" parameter to links generated by custom fields.
- Fix: custom fields editors table list vue components parameters update to match latest version of scripts.
