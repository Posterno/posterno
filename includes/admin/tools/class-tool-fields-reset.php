	...
	public function page() {
		...
		<div class="postbox">
			<h2 class="hndle ui-sortable-handle">
				<span><?php esc_html_e( 'Reset custom fields' ); ?></span>
			</h2>
			<div class="inside">
				<p><?php esc_html_e( 'This tool deletes your custom fields and re-installs default fields.' ); ?></p>
