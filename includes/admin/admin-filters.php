 ...
 * @return array
 */
function pno_set_conditional_logic_for_headings_listings( $fields ) {
	...
	$hidden_fields = [
		...
		'profile_field_label',
		'profile_field_placeholder',
		'profile_field_description',
		'profile_field_is_required',
		'profile_field_is_admin_only',
	];
...
add_filter( 'pno_listings_fields_general_settings', 'pno_set_conditional_logic_for_headings_listings' );
add_filter( 'pno_listings_fields_validation_settings', 'pno_set_conditional_logic_for_headings_listings' );
add_filter( 'pno_listings_fields_permissions_settings', 'pno_set_conditional_logic_for_headings_listings' );
 ...
 * @return array
 */
function pno_set_conditional_logic_for_headings_profiles( $fields ) {
