<?php
/**
 * Handle the personal data request form.
 *
 * @package     posterno
...
/**
 * Handle the Posterno's data request form.
 */
class DataRequestForm extends Forms {

	/**
	 * Get things started.
	 */
	public function __construct() {
		$this->form_name    = 'data_request_form';
		$this->submit_label = esc_html__( 'Request personal data' );
		parent::__construct();
	}
	...
	public function get_fields() {
		...
		/**
		 * Allow developers to customize the data export form fields.
		 *
		 * @param array $fields the list of fields.
		 * @return array the list of fields.
		 */
		return apply_filters( 'pno_data_export_form_fields', $fields );
	...
	public function hook() {
		...
		add_shortcode( 'pno_request_data_form', [ $this, 'shortcode' ] );
	}
			...
			posterno()->templates
				->set_template_data(
					[
						...
						'title'        => esc_html__( 'Download your data' ),
						'message'      => sprintf(
