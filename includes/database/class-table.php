...
if ( ! class_exists( '\\PNO\\Database\\Tables\\Base' ) ) :
	/**
	 ...
	 * @since 1.0.0
	 */
	abstract class Table extends \PNO\Database\Base {
		 ...
		 */
		protected $file = PNO_PLUGIN_FILE;
		...
		public function upgrade() {
			...
			$upgrades = array_filter(
				(array) $this->upgrades, function ( $value ) {
