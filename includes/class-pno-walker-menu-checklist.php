<?php
/**
 * Create a set of Posterno-specific links for use in the Menus admin UI.
 *
 * @package     posterno
 ...
 * @since 1.0.0
 */
class PNO_Walker_Menu_Checklist extends Walker_Nav_Menu {
	...
	function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
		...
		if ( ! in_array( array( 'pno-menu', 'pno-' . $item->post_excerpt . '-nav' ), $item->classes ) ) {
			$item->classes[] = 'pno-menu';
			$item->classes[] = 'pno-' . $item->post_excerpt . '-nav';
		}
