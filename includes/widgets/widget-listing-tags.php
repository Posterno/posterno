<?php
/**
 * Handles the listing tags widget for the single listing page.
 *
 * @package     posterno
...
/**
 * Registers the single listing tags widget.
 */
class ListingTags extends Widget {
	...
	public function __construct() {
		$this->setup(
			'pno_listing_tags_widget',
			esc_html__( '[Posterno] Listing tags' ),
			esc_html__( 'Displays the current listing\'s tags.' ),
			array(
				Field::make( 'text', 'title', esc_html__( 'Title' ) ),
			),
			'pno-widget-listing-tags'
		);
	}
	...
	public function front_end( $args, $instance ) {
		...
		posterno()->templates
			...
			->get_template_part( 'widgets/listing-tags' );
