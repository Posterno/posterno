 ...
 */
class PNO_Action_Queue implements PNO_Queue_Interface {
	 ...
	 * @return PNO_DateTime|null The date and time for the next occurrence, or null if there is no pending, scheduled action for the given hook.
	 */
	public function get_next( $hook, $args = null, $group = '' ) {
		...
		if ( $next_timestamp ) {
			return new PNO_DateTime( "@{$next_timestamp}", new DateTimeZone( 'UTC' ) );
		}
