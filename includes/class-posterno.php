...
if ( ! class_exists( 'Posterno' ) ) :
	...
	final class Posterno {
		...
		private function setup_utilities() {
			...
			require_once PNO_PLUGIN_DIR . 'includes/class-pno-currency-helper.php';
		...
		private function setup_objects() {
			...
			require_once PNO_PLUGIN_DIR . 'includes/emails/emails-actions.php';
